    ...
    return (
        <>
            {/* <div
                ...
                className={`z-[999] w-full h-full fixed top-0 left-0 bg-linear-to-t from-[#e9fe00ea] to-[#ffffff00] from-50% z-50 flex items-center justify-center transition-opacity duration-300 ${isFadingOut ? 'opacity-0 pointer-events-none' : 'opacity-100'
                    }`}
            >
